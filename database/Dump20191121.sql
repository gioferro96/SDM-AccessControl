...
CREATE TABLE `data` (
  ...
  CONSTRAINT `data_ibfk_2` FOREIGN KEY (`uploaderid`) REFERENCES `users` (`id`)
...
INSERT INTO `data` VALUES (12,14,'2013-09-23','ECG','good ecg results, no problem'),(12,14,'2019-11-21','check','astmha (o come cazzo si scrive)'),(10,20,'2019-11-21','check','feels happy'),(11,2,'2019-11-21','check','feels tired, better to sleep a lot tomorrow');
...
-- Dump completed on 2019-11-21 11:06:02
